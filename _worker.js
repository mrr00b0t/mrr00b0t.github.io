...
let addresses = [
	'icook.tw:443#t.me/Zero_Free_Vpn',//Official preferred domain name
	//'cloudflare.cfgo.cc:443#YouTube',
	'visa.com:443#t.me/Zero_Free_Vpn'
];

let autoaddress = [
	'www.opensignal.com:443',
	'cloudflare.cfgo.cc:443',
	'es.opensignal.com:443'
];
...
function getVLESSConfig(userIDs, hostName) {
	...
	const output = userIDArray.map((userID) => {
		...
		return `################################################################
🌟အပေါ်မှာပေးထားတဲ့ အကွက်ထဲက(ဒီစာတန်းကိုနှိပ်ပြီးယူပါ)ဆိုတဲ့ နေရာကို နှိပ်ယူပြီး V2rayNG & V2flyNG မှာထည့်ပြီး Update Suscription လုပ်ပြီးအသုံးပြုနိူင်ပါပြီ🌟
---------------------------------------------------------------
Script – 4-0-4(nkka)

🚨Developed fixed by-( မောင်သုည )🚨
---------------------------------------------------------------
🌟အောက်ဆုံးမှာရှိတဲ့ Vless Main Key 2 ခုကိုလည်း COPY ယူပြီး အသုံးပြုနိူင်ပါသည်🌟
################################################################
...
`;
	...
	// Prepare header string
	const header = `
<p align='center'><img src='https://raw.githubusercontent.com/BaeGyee/BaeGyee/refs/heads/main/baegyee.png?raw=true' alt='' width="300" height="300" style='margin-bottom: -0px;'>
<b style='font-size: 15px;'>Welcome! This function generates configuration for ᴢᴇʀᴏᵛᵖⁿ protocol. If you found this useful, please join our Telegram Link for more:</b>
	<b style='font-size: 15px;'>ONLY/:FORYOU&ALL</b>
<a href='https://t.me/zero_freevpn' style="color: #fff;font-size: 15px;background-color: #5cb85c;" target='_blank'>Click To Join Telegram Link</a>
...
<button onclick='copyToClipboard("${subbestip}")'><i class="fa fa-clipboard"></i>🌟ဒီစာတန်းကိုနှိပ်ပြီးယူပါ🌟</button><br>
<a href='https://t.me/Zero_Free_Vpn' style="color: #fff;font-size: 10px;background-color: #f90083;" target='_blank'>xxxxxxxxxxxxxxxxxxxxxxxxx</a>
...
async function nginx() {
	...
	<html>
	<head>
	<title>Welcome to မောင်သုညᶻᵉʳᵒᵛᵖⁿ</title>
	<style>
		body {
			width: 35em;
			margin: 0 auto;
	...
	<body>
	<h1>Welcome to မောင်သုညᶻᵉʳᵒᵛᵖⁿ</h1>
	<p align='center'><jpg src='https://raw.githubusercontent.com/BaeGyee/BaeGyee/refs/heads/main/baegyee.png?raw=true' alt='' width="150" height="150" style='margin-bottom: -0px;'>
	<b style='font-size: 15px;'>Welcome! This function generates configuration for Biluisland protocol. If you found this useful, please join our Telegram Link for more:</b>
	<b style='font-size: 15px;'>ONLY/:FORYOU&ALL</b>
	<p>If you see this page, web server is successfully installed and
	working. Further configuration is required.</p>

	<p>For online documentation and support please refer to
	<a href="http://t.me/zero_freevpn/">👉Telegram Link👈</a>.<br/>

	<p><em>🙏Thank you for using🙏 🌟မောင်သုည ᶻᵉʳᵒᵛᵖⁿ🌟.</em></p>
	</body>
	</html>
	`
	return text;
